...
INSERT INTO `forum`.`user` (`id`, `email`, `phone`, `password`, `is_admin`, `name`, `grade`, `avatar`, `if_receive_like`) VALUES ('1', 'y@y.com', '18300000985', 'yyy111', '1', 'Yiiie.', '7', '/var/1', '0');
INSERT INTO `forum`.`user` (`id`, `email`, `phone`, `password`, `is_admin`, `name`, `grade`, `avatar`, `if_receive_like`) VALUES ('2', '3@3.com', '18300003030', 'sss333', '0', '张三', '3', '/var/2', '1');
